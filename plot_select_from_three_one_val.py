...
for experiment in experiments_list:
    ...
    u = np.load('experiments/Three_cov_one_val/{}/u.npy'.format(folder_name))
    ...
    for i_dist in tqdm(range(num_dist)):
        Hu = entropy(u[i_dist])
        Hu_list.append(Hu)
        Hw_z_arr = np.load('experiments/Three_cov_one_val/{}/s{}_Hw_z.npy'.format(folder_name, i_dist))
        Iyz_arr = np.load('experiments/Three_cov_one_val/{}/s{}_Iyz.npy'.format(folder_name, i_dist))
        Izw_arr = np.load('experiments/Three_cov_one_val/{}/s{}_Izw.npy'.format(folder_name, i_dist))
        
        Hw_v1_arr = np.load('experiments/Three_cov_one_val/{}/s{}_Hw_v1.npy'.format(folder_name, i_dist))
        Iyv1_arr = np.load('experiments/Three_cov_one_val/{}/s{}_Iyv1.npy'.format(folder_name, i_dist))
        Iv1w_arr = np.load('experiments/Three_cov_one_val/{}/s{}_Iv1w_.npy'.format(folder_name, i_dist))

        Hw_v2_arr = np.load('experiments/Three_cov_one_val/{}/s{}_Hw_v2.npy'.format(folder_name, i_dist))
        Iyv2_arr = np.load('experiments/Three_cov_one_val/{}/s{}_Iyv2.npy'.format(folder_name, i_dist))
        Iv2w_arr = np.load('experiments/Three_cov_one_val/{}/s{}_Iv2w.npy'.format(folder_name, i_dist))
        ...
        if (cce_v1 - cce_z >= eps) and (cce_v2 - cce_z >= eps):
            correct_count += 1
...
plt.plot(cce_z_arr, 'o', label=r'CCE$_\mathcal{IV}(Z;Y|X,V_1,V_2)$')
plt.plot(cce_v1_arr, 'o', label=r'CCE$_\mathcal{IV}(V_1;Y|X,Z,V_2)$')
plt.plot(cce_v2_arr, 'o', label=r'CCE$_\mathcal{IV}(V_2;Y|X,Z,V_1)$')
